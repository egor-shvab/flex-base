...
**Nothing is in progress.** The feature set and the test suite are done, and the Open-limitations phase is finished: one **Open** row is left in `docs/decisions.md`, and it is the parked item below rather than a stage.
